...
import { ArrowLeft, ArrowRight, Home, CheckCircle, MapPin, Shield, Building2, Users, Star, Phone, Mail, MessageCircle, Sparkles } from "lucide-react"
            ...
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-semibold text-amber-300">
                  {locale === "en" ? "Verified Housing" : "سكن معتمد"}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-800">
                  ...
                  <span className="text-slate-400 text-sm ml-2">{locale === "en" ? "Inspected" : "مفحوص"}</span>
                </div>
                <div className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-800">
                  <span className="text-amber-400 font-bold">24h</span>
                  <span className="text-slate-400 text-sm ml-2">{locale === "en" ? "Near Campus" : "قرب الحرم"}</span>
                </div>
              </div>
            </div>
