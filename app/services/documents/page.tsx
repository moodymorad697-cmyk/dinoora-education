...
import { ArrowLeft, ArrowRight, FileStack, CheckCircle, Clock, Shield, Award, FileCheck, Phone, Mail, MessageCircle, Globe, Languages, Stamp, Sparkles } from "lucide-react"
    ...
    <main className="min-h-screen bg-slate-950">
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="https://images.unsplash.com/photo-1568667256549-094345857637?w=1600&q=85"
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-800">
                  ...
                  <span className="text-slate-400 text-sm ml-2">{locale === "en" ? "Languages" : "لغة"}</span>
                </div>
                <div className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-800">
                  <span className="text-amber-400 font-bold">3-5</span>
                  <span className="text-slate-400 text-sm ml-2">{locale === "en" ? "Days Delivery" : "أيام توصيل"}</span>
                </div>
              </div>
            </div>
