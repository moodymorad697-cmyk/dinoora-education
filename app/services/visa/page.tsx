...
import { ArrowLeft, ArrowRight, Stamp, CheckCircle, Zap, Shield, Clock, FileCheck, Users, Phone, Mail, MessageCircle, Globe, Award, Sparkles } from "lucide-react"
    ...
    <main className="min-h-screen bg-slate-950">
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1600&q=85"
            alt="Visa Documents"
            fill
            ...
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-semibold text-amber-300">
                  {locale === "en" ? "98% Success Rate" : "98% نسبة نجاح"}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                {stats.map((stat, i) => (
                  <div key={i} className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-800">
