...
import { ArrowLeft, ArrowRight, HeartHandshake, CheckCircle, Calendar, GraduationCap, AlertCircle, Briefcase, Users, Mail, MessageCircle, Sparkles } from "lucide-react"
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Student Support Background"
            fill
            ...
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6">
                ...
                <span className="text-sm font-semibold text-amber-300">
                  {locale === "en" ? "Always Here For You" : "دائماً هنا من أجلك"}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-800">
                  <span className="text-amber-400 font-bold">{locale === "en" ? "Full" : "كامل"}</span>
                  <span className="text-slate-400 text-sm ml-2">{locale === "en" ? "Journey" : "الرحلة"}</span>
                </div>
              </div>
            </div>
